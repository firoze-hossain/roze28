...
- 🖥 **Front-end:** 
  - **📜 Languages:** • `🧙🏻 Java 8 & 11` • `👨‍🏭 XAML` • `👨‍🔧 JavaScript` • `🧚🏻‍♂️ HTML` • `👨🏻‍🎨 CSS`
  - **🔬 Frameworks:**  
    - **🖥 Desktop:** • [DTest](https://github.com/firoze-hossain) 
    - **🌐 Web:** • [WTest](https://github.com/firoze-hossain) • [WTest2](https://github.com/firoze-hossain) 
    - **📱 Mobile:** • [ilife](https://leadsoft.com.bd/portfolio/i-life/) 
- 🗄️ **Back-end:**
...
- 🎡 **Software development ecosystem:**
  ...
  - **🗂 CI/CD:** • [Jenkins](https://www.jenkins.io/) • [Azure Pipelines](https://azure.microsoft.com/en-us/services/devops/pipelines/) • [Github Actions](https://github.com/features/actions) • [Github Pages](https://pages.github.com/)
